    ...
    <header class="header" id="home">
        <div class="container">
            <div class="infos">
                ...
                <h6 class="title">Biraj Shrestha</h6>
            ...
            <div class="img-holder">
                <img src="{{ asset('frontend/assets/imgs/biraj.png') }}" alt="">
            </div>
        </div>
    ...
    <section id="about" class="section mt-3">
        <div class="container mt-5">
            <div class="row text-center text-md-left">
                <div class="col-md-3">
                    <img src="{{ asset('frontend/assets/imgs/avatar.jpg') }}" alt="" class="img-thumbnail mb-4">
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <p>Copyright
                        ...
                        </script> &copy; <a href="http://www.devcrud.com" target="_blank">DevCRUD</a>
                    </p>
                </div>
                <div class="col-sm-6">
                    <div class="socials">
